...
-- ANSWER -- exported to a csv file with name "hourly trend of the total pizza's sold, total orders placed & total revenue generated"
...
-- ANSWER -- exported to a csv file with name "daily trend of the total pizza's sold, total orders placed & total revenue generated - day name"
...
-- ANSWER -- exported to a csv file with name "daily trend of the total pizza's sold, total orders placed & total revenue generated - day of month"
...
-- ANSWER -- exported to a csv file with name "weekly trend of the total pizza's sold, total orders placed & total revenue generated"
...
-- ANSWER -- exported to a csv file with name "monthly trend of the total pizza's sold, total orders placed & total revenue generated"
...
-- ANSWER -- exported to a csv file with name "quarterly trend of the total pizza's sold, total orders placed & total revenue generated"
...
-- ANSWER -- exported to a csv file with name "total orders, total quantity sold, total revenue generated & percentage of pizza sales by pizza category"
...
GROUP BY pizza_size
ORDER BY percent_pizza_sales DESC;
-- ANSWER -- exported to a csv file with name "total orders, total quantity sold, total revenue generated & percentage of pizza sales by pizza size"
...
-- ANSWER -- exported to a csv file with name "total orders, total quantity sold, total revenue generated & percentage of pizza sales by pizza category & pizza size"
...
-- ANSWER -- exported to a csv file with name "total orders, total quantity sold, total revenue generated categorized by pizza name - Top 5 by total revenue"
...
-- ANSWER -- exported to a csv file with name "total orders, total quantity sold, total revenue generated categorized by pizza name - Bottom 5 by total revenue"
...
-- ANSWER -- exported to a csv file with name "total orders, total quantity sold, total revenue generated categorized by pizza name - Top 5 by quantity sold"
...
-- ANSWER -- exported to a csv file with name "total orders, total quantity sold, total revenue generated categorized by pizza name - Bottom 5 by quantity sold"
...
-- ANSWER -- exported to a csv file with name "total orders, total quantity sold, total revenue generated categorized by pizza name - TOP 5 by orders placed"
...
-- ANSWER -- exported to a csv file with name "total orders, total quantity sold, total revenue generated categorized by pizza name - Bottom 5 by orders placed"